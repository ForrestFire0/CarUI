<script>
    /*
        BIG NUMBER, VERY BOLD carlie
        important numbers we are interested in
        - Current Speed
        - Gs in X and Y
        - Output Power
        - Motor Current
    ...
    import {gForceScale} from "../SvelteComponents/stores";
</script>
...
<div id="container">
    ...
    <div><GForceMonitor/>G Force Scale: {$gForceScale}g <br>{$deviceStatusData.lastFrontContact}</div>
